...
I summarize three classical approaches to hypothesis testing in [this blog
post]({% post_url 2020-06-19-hypothesis-testing %}).

### Degree of freedom in statistical testing

I summarize the mathematical concept of *constraint* and the statistical concept
of *degree of freedom*, and its derivation in various settings, in [this blog
post]({% post_url 2020-06-18-degrees-of-freedom %}).
